...
def getIfxUrl(name):
    ...
    urls = {
        ...
        'NICE_GET_ORGS_WITH_BILLING': '/'.join([NICE_API_BASE, 'billling/get-orgs-with-billing/']),
        ...
        'HERS_GET_ORGS_WITH_BILLING': '/'.join([HERS_API_BASE, 'billling/get-orgs-with-billing/']),
        ...
        'COLDFRONT_GET_ORGS_WITH_BILLING': '/'.join([COLDFRONT_API_BASE, 'billling/get-orgs-with-billing/']),
        ...
        'CBSN_GET_ORGS_WITH_BILLING': '/'.join([CBSN_API_BASE, 'billling/get-orgs-with-billing/']),
        ...
        'BOAR_GET_ORGS_WITH_BILLING': '/'.join([BOAR_API_BASE, 'billling/get-orgs-with-billing/']),
    }
