...
COLDFRONT_API_BASE = os.environ.get('COLDFRONT_API_BASE', 'http://coldfront.rc.fas.harvard.edu/ifx/api').rstrip('/')
COLDFRONT_URL_BASE = os.environ.get('COLDFRONT_URL_BASE', 'http://coldfront.rc.fas.harvard.edu').rstrip('/')
